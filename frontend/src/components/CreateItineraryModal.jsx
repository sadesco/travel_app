...
export default function CreateItineraryModal({ user, tripId, onClose, onCreated }) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    const res = await addItineraryItem({ ...form, trip_id: tripId, user_id: user.user_id });
    setLoading(false);
    ...
    <div style={styles.overlay}>
      <div style={styles.modal}>
        <div style={styles.modalHeader}>
          <h2 style={styles.title}>Add to Itinerary</h2>
